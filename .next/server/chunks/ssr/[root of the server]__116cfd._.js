...
const CursorCircle = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$components$2f$dist$2f$styled$2d$components$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].div`
  ...
  transform: ${(props)=>props.$cursorStyle === "pointer" ? "scale(1.5)" : props.$cursorStyle === "text" ? "scale(1.8)" : "scale(1)"};
  opacity: ${(props)=>props.$cursorStyle === "pointer" ? "0.5" : props.$cursorStyle === "text" ? "0.4" : "0.2"};
`;
const CustomCursor = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (!isTouchDevice) {
            ...
            const handleMouseOver = (e)=>{
                ...
                if (target.tagName === "INPUT" || target.tagName === "TEXTAREA" || target.getAttribute("contenteditable") === "true" || target.tagName === "P" || /^H[1-6]$/.test(target.tagName) || target.closest('[contenteditable="true"]') || target.classList.contains("cursor-text")) {
                    setCursorStyle("text");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__116cfd._.js.map